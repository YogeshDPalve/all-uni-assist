  ...
  return (
    <footer className="relative z-10 mt-8 w-full overflow-hidden pt-16 pb-8">
      ...
      <div className="pointer-events-none absolute top-0 left-1/2 z-0 h-full w-full -translate-x-1/2 select-none">
        <div className="absolute -top-32 left-1/4 h-72 w-72 rounded-full bg-gray-600/20 blur-3xl"></div>
        <div className="absolute right-1/4 -bottom-24 h-80 w-80 rounded-full bg-gray-600/20 blur-3xl"></div>
      </div>
      <div className="glass relative mx-auto flex max-w-6xl flex-col items-center gap-8 rounded-2xl px-6 py-10 md:flex-row md:items-start md:justify-between md:gap-30">
        <div className="flex flex-col items-center md:items-start">
          <a href="#" className="mb-4 flex items-center gap-2">
            <span className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-slate-600 to-gray-900 text-2xl font-extrabold text-white shadow-md">
              <Bot />
            </span>
            <span className="bg-gradient-to-br from-blue-200 to-blue-400 font-bold bg-clip-text text-xl text-transparent">
              All Uni Assist
            </span>
          </a>
          ...
          <div className="mt-2 flex gap-3 text-rose-400 dark:text-primary">
            <a
              href="#"
              aria-label="Twitter"
      ...
      <div className="text-foreground relative z-10 mt-10 text-center text-xs">
        <span>&copy; 2025 All Uni Assist. All rights reserved.</span>
      </div>
    </footer>
  );
}
